...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Mean:    {:.4}    {:.4}    {:.4}", hf_mean, our_mean, our_mean - hf_mean);
    println!("Min:     {:.4}    {:.4}    {:.4}", hf_min, our_min, our_min - hf_min);
    println!("Max:     {:.4}    {:.4}    {:.4}", hf_max, our_max, our_max - hf_max);
    ...
    println!("Maximum difference: {:.4} at frame={}, mel={}", max_diff, max_diff_pos.0, max_diff_pos.1);
